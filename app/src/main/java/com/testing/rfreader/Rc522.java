...
public class Rc522 {
    ...
    public Rc522(UsbSerialPort spiDevice) throws IOException {
...
//    }
    private void initializeDevice(){
        reset();
        writeRegister(REGISTER_TIMER_MODE, (byte) 0x80);
        writeRegister(REGISTER_TIMER_PRESCALER_MODE, (byte) 0xA9);
        writeRegister(REGISTER_TIMER_RELOAD_LOW, (byte) 0xE8);
        writeRegister(REGISTER_TIMER_RELOAD_HIGH, (byte) 0x03);
        writeRegister(REGISTER_TX_MODE, (byte) 0x40);
        writeRegister(REGISTER_MODE, (byte) 0x3D);
        setAntenna(true);
    }
...
//        try {
//            device.write(buffer, 500);
//            Log.v(TAG , "W: " + MyUtils.bytesToHex(buffer));
//            device.read(response, 500);
//            Log.v(TAG , "R: " + MyUtils.bytesToHex(response));
//        } catch (IOException e) {
//            e.printStackTrace();
//        }
//    }
